...
- Name: accessibility\color-contrast.spec.js >> [Presentación] WCAG AAA contraste >= 7:1
...
+     "required": 7,
+     "tag": "p",
+     "text": "Accede al buscador y revisa todos los beneficios disponibles",
+     "x": 688,
+     "y": 396,
+   },
+ ]
...
```yaml
- generic [ref=e4]:
  - heading "Bienvenido a la plataforma de beneficios" [level=1] [ref=e5]
  - paragraph [ref=e6]: Este sitio está diseñado para ayudarte a encontrar beneficios, apoyos y servicios disponibles para personas mayores de forma clara, simple y accesible.
  - generic [ref=e7]:
    - generic [ref=e8]:
      - heading "¿Cómo funciona?" [level=2] [ref=e12]
      - list [ref=e13]:
        - listitem [ref=e14]: Explora las categorías de beneficios disponibles.
        - listitem [ref=e15]: Revisa los requisitos y condiciones de cada beneficio.
        - listitem [ref=e16]: Encuentra dónde acceder y cómo postular.
    - generic [ref=e17]:
      - generic [ref=e18]:
        - heading "Comenzar" [level=2] [ref=e19]
        - paragraph [ref=e20]: Accede al buscador y revisa todos los beneficios disponibles.
      - button "Entrar a la plataforma" [ref=e21]
```
